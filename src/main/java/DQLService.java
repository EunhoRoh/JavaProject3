...
public class DQLService {
    ...
    final String SELECTALL_SQL = "SELECT * FROM DATA ";
    final String SELECTBYNAME_SQL = "SELECT * FROM DATA WHERE NAME = ? ";
    ...
    public void printMapList(List<Map<String, Object>> mapList) {
        ...
        // 상세 데이터 출력
        /*System.out.println("No Name Part Exercise NumOfSets Reps Weight RegDate");
        System.out.println("==========================================");*/
        ...
        for(int i = 0; i < mapList.size(); i++) {
            ...
            System.out.println("Schedule [ID="+id +", Name="+name+", Part="+part
                    +", exercise="+exercise +", Sets="+numOfSets+", reps="+reps+", Weight="+weight+"kg]"+", Date="+reg_date);
